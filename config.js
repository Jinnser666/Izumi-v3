...
module.exports = {
  ...
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/mF1GPi5.jpeg",
  CAPTION: process.env.CAPTION || "ᴊɪɴɴ ꜱᴇʀ",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "ᴊɪɴɴ ꜱᴇʀ xᴅ",
  BOT_NAME: process.env.BOT_NAME || " 𝐉𝚰𝚴𝚴 𝐒𝚵𝚪 𝚾𝐃",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "ᴊɪɴɴ ꜱᴇʀ xᴅ",
